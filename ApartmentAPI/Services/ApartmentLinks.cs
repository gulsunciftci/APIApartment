...
namespace Services
{
    public class ApartmentLinks : IApartmentLinks
    {
        ...
        public ApartmentLinks(LinkGenerator linkGenerator, 
            IDataShaper<ApartmentDto> dataShaper)
        {
            _linkGenerator = linkGenerator;
            _dataShaper = dataShaper;
        }

        public LinkResponse TryGenerateLinks(IEnumerable<ApartmentDto> booksDto, 
            string fields, 
        ...
        private LinkResponse ReturnLinkedBooks(IEnumerable<ApartmentDto> booksDto, 
            string fields, 
            HttpContext httpContext, 
        ...
        private List<Entity> ShapeData(IEnumerable<ApartmentDto> booksDto, string fields)
        {
            return _dataShaper
